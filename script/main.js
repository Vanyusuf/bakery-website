...
//                 <button class="btn-buy" onclick="addToCart(this.parentElement.previousElementSibling.querySelector('.value').innerText)"><span class="material-symbols-outlined">shopping_cart</span>ADD TO CART</button>
//             </div>
//         </div>    
//         `
//     });
...
// const addToCart = (valueCounter) =>{
//     // let btnCart = this;
//     let cartValue = parseInt(cartItemValue.innerText)
//     // console.log(typeof(cartValue))
//     let value = parseInt(valueCounter)
//     // console.log(typeof(value))
//     let newValue = cartValue + value;
//     console.log(newValue)
//     cartItemValue.innerHTML = newValue
// };